        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/elevateseous" className="w-10 h-10 bg-teal-600 rounded-full flex items-center justify-center hover:bg-teal-700 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/elevateseo" className="w-10 h-10 bg-teal-600 rounded-full flex items-center justify-center hover:bg-teal-700 transition-colors">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/elevateseo_us/" className="w-10 h-10 bg-gradient-to-r from-teal-500 to-teal-600 rounded-full flex items-center justify-center hover:from-teal-600 hover:to-teal-700 transition-colors">
            ...
            <ul className="space-y-3">
              <li>
                <button 
                  ...
                  className="text-gray-300 hover:text-teal-400 transition-colors hover:underline"
                >
                  Home
                </button>
              </li>
